export default {
  ...
  READ_NFT_OWNSHIP_SUCCESS: 'NFT 소유 여부 조회 성공',
  CREATE_WELCOME_NFT_SUCCESS: 'Welcome NFT 민팅 성공',
  CREATE_INVITE_CODE_SUCCESS: '입장 코드 발급 성공',
  GET_EXTERNAL_NFT_SUCCESS: '외부 NFT 가져오기 성공',
  MINT_EXTERNAL_NFT_SUCCESS: '외부 NFT 민팅 성공',
  ...
  UPDATE_LANGUAGE_SUCCESS: '서비스 언어 변경 성공',
  CHARGE_YRP_SUCCESS: 'YRP 충전 성공',
  READ_YRP_SUCCESS: '총 YRP 조회 성공',
  READ_YRP_DETAIL_SUCCESS: 'YRP 거래내역 조회 성공',

  //MARKETPLACE
  READ_MARKET_NFT_DETAIL_SUCCESS: '마켓플레이스 nft 상세 정보 조회 성공',
  READ_MARKET_DASHBOARD_SUCCESS: '마켓플레이스 대시보드 조회 성공',
  ADD_LIKE_SUCCESS: '마켓플레이스 좋아요 추가 성공',
  SUB_LIKE_SUCCESS: '마켓플레이스 좋아요 취소 성공',
  IS_LIKED_DASHBOARD: '이미 좋아요를 누른 게시물입니다.',
  NO_LIKED_DASHBOARD: '좋아요를 누르지 않은 게시물입니다.',
  BUY_NFT_SUCCESS: 'NFT 구매 성공',
  BUY_NFT_FAIL: 'NFT 구매 실패',
  NOT_EQUAL_PRICE: '가격 불일치',
  NO_NFT: '존재하지 않는 NFT',
  INSUFFICIENT_BALANCE: '잔액 부족',
  SELL_NFT_SUCCESS: 'NFT 판매 리스팅 성공',
  BALANCE_ERROR: '잔액 오류',
